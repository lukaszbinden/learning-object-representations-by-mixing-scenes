...
% TODO: use images in D:\learning-object-representations-by-mixing-scenes\src\results\dump_mixes\190221\20190221_133431_dump_mixes5cols or gen. new
...
\ForEach{$X_{qi}$} {
    compute representations for all images in $X_{qi}$\;
    cluster representations with \textit{k}-means\;
    \ForEach{cluster $c$} {
        \ForEach{representation $f \in c$} {
            compute 10 nearest representations $tnf$ in $c$ with \textit{k}-nn and L2 distance\;
