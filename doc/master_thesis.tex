...
Using our method in inference mode, we showcase synthesized mixed scenes along with the corresponding input images in Figure~\ref{fig:results_lorbms_mixed_scenes}. All the data is taken from the MS COCO test set. To produce these results only the autoencoder of our method, that is the encoder and the decoder as described in \ref{subsec:model_arch}, are used. See Appendix~\ref{app:samples} for more examples.

% images_all/ex54_*: D:\learning-object-representations-by-mixing-scenes\src\results\tboard\lorbms\190401\exp73\test_images\test
\begin{figure}[h!]
     \centering
     \begin{subfigure}[b]{0.9\textwidth}
         \centering
         \includegraphics[width=\textwidth]{images/images_all/mixed_scene_legend.png}
         \includegraphics[width=\textwidth]{images/images_all/000000059468_2-000000143935_1-000000225515_2-000000059468_1-000000411508_2-0001-img_mix_gen_4908.jpg}
         \caption{Examples with one replacement quadrant}
         \label{fig:results_lorbms_mixed_scenes_1}
     \end{subfigure}
     \hfill
     % new row
     \begin{subfigure}[b]{0.9\textwidth}
         \centering
         \caption{Examples with two replacement quadrants}
         \includegraphics[width=\textwidth]{images/images_all/000000075814_1-000000581767_1-000000036993_2-000000538271_1-000000529911_1-0100-img_mix_gen_4899.jpg}
         \label{fig:results_lorbms_mixed_scenes_2}
     \end{subfigure}
     \hfill     
     % new row
     \begin{subfigure}[b]{0.9\textwidth}
         \centering
         \includegraphics[width=\textwidth]{images/images_all/000000201034_1-000000527694_1-000000085985_2-000000552190_2-000000410087_1-0010-img_mix_gen_4978.jpg}
         \includegraphics[width=\textwidth]{images/images_all/000000391878_1-000000177006_2-000000552323_2-000000464944_1-000000460581_1-0010-img_mix_gen_4941.jpg}
         \caption{Examples with three replacement quadrants}
         \label{fig:results_lorbms_mixed_scenes_4}
     \end{subfigure}
    \caption{Examples of synthesized mixed scenes shown in rightmost column using our method.}
...
TBD
\subsubsection{Predicting image rotations using LORBMS as feature extractor}\label{subsec:linearclassifier}
