...
\KwResult{A mixed feature vector $f_{I_{mix}}$ from two to four images}
...
\end{itemize}
Therefore, the number of replaced quadrants and features, respectively, in $f_{I_{mix}}$ is always between one and three. In other words, the mixed scene will always be made up of between two and four images. See section TODO-section for visual depictions of the mixed feature vector.
