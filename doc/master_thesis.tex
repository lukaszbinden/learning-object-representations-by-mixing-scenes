...
The present thesis devises a novel machine learning model capable of learning object representations by mixing scenes. The learnt object representations open up a variety of possible downstream applications such as object interpolation. The model is trained in an unsupervised fashion without any human interference. Our work aims to produce a representation that is made up of disentangled factors of variation representing 
