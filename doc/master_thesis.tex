...
% for documentclass "book" and "twosided report"
...
% COULD: point out the difference between convolution and cross-correlation
...
% COULD 17.05: if time left, improve this paragraph
...
%\includepdf[pages=2,width=1\textwidth]{lorbms_model_prettyprint.pdf}
\includegraphics[page=2,width=1\textwidth]{lorbms_model_prettyprint.pdf}
...
% COULD show examples where 1) quadrants contain more than one object, 2) quadrants contain only part of an object, 3) quadrants are without object
...
\hline
Ours (knowledge transfer~\cite{KnowledgeTransfer}, discriminator) & \textbf{42.9}\% & $\pm$0.3 & 40,970 \\ % 11.05 log_knowledgetransfer_Dsc_64px_No1_60Ep.out, log_linearcls_knowledgetransfer_alexnet_Dsc_60Ep_frozen_96px_No1.out: [42.5,0.4], log_linearcls_knowledgetransfer_alexnet_Dsc_100Ep_frozen_96px_No2.out: [42.9,0.3]
...
\centering
\begin{subfigure}{0.49\textwidth}
\includegraphics[scale=0.45]{ablation_study_stl10.png}
\caption{STL-10 test set accuracy}
\label{fig:ablation_stl10}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\includegraphics[scale=0.45]{ablation_study_fid.png}
...
% COULD: evtl noch ohne SN probieren?
