...
% TODO see http://cs231n.stanford.edu/slides/2017/cs231n_2017_lecture9.pdf
...
\hline
 Higgins \textit{et al.}~\cite{betaVAE} & $\beta$-VAE & unsupervised & celebA, chairs, faces \\
\hline
...
PASCAL encoder & 38.1\% & $\pm$0.2  \\ % 14.04: definitiv (cf. log_pascal4.out, log_pascalvoc_4th_as3_withMomOptim.out)
PASCAL encoder (AlexNet) & tbd\% & $\pm$tbd  \\
STL-10 encoder & 43.8\% & $\pm$0.5 \\ % 02.04: definitiv (200ep)
STL-10 encoder (AlexNet) & 40.0\% & $\pm$0.2 \\ % 17.04: tentativ: log_alexnetNo1.out (200ep) TODO: dataaug resize/crop
\hline
