...
\begin{figure}[ht!]
     ...
     \end{subfigure}     
    \caption{Examples of mixed feature vectors in data space. On the left is $I_{ref}$, on the right is the mixed scene $I_{mix}$. Starting from the top left corner, the binary mask denotes clockwise (0) original quadrant and (1) replacement quadrant.}
