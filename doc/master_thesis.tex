...
The generator is composed of the encoder and the decoder. The encoder $E$ maps an image $A$ into a latent space representation
...
By swapping some of the feature vector chunks we obtain a new, mixed representation $[a_1, b_2, c_3, d_4]$ where $a_1,b_2,c_3,d_4$ represent quadrants from possibly different input images. Using decoder $D$, said representation is decoded into a new image $I_{mix}$ as
