...
class DCGAN(object):
    ...
    def build_model(self):
        ...
        file_train = self.params.tfrecords_path if not self.isIdeRun else '../data/train-00011-of-00060.tfrecords'
        ...
        path = self.params.full_imgs_path if not self.isIdeRun else 'D:\\learning-object-representations-by-mixing-scenes\\src\\datasets\\coco\\2017_training\\version\\v4\\full\\'
    ...
    def dump_features(self, params):
        ...
        print("params.extractor_type: %s" % params.extractor_type)
        if params.extractor_type == "encoder":
    ...
    def dump_features_iter(self, iteration):
        ...
        for i in range(self.batch_size):
            ...
            self.features_filenames[((iteration-1) * self.batch_size) + i] = fnames[i]
    ...
    def restore_encoder(self, params):
        ...
        path = params.extractor_checkpoint_name if not self.isIdeRun else "../checkpoints/exp70/checkpoint/DCGAN.model-50"
