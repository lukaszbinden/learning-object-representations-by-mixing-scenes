...
class DCGAN(object):
    ...
    def build_model(self, is_train):
        ...
        with tf.variable_scope('generator') as scope: 
            ...
            # mix the features for the two test images START
            i = 0
    ...
    def train(self, config, run_string="???"):
        ...
        g_loss = 10*self.recR_loss +10*self.rec_mix_loss+1*self.g_loss+1*self.cf_loss
        # for autoencoder
        ...
        try:
            ...
            while not coord.should_stop():
                ...
                if np.mod(counter, 4000) == 2:
                    # print out images evey 4000 batches
