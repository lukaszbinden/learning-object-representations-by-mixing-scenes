...
class DCGAN(object):
    ...
    def build_model(self):
        ...
        with tf.variable_scope('generator') as scope_generator:
            ...
            res = encoder_dense(self.images_I_ref, self.batch_size, self.feature_size)
            assert self.I_ref_f1.shape == res.shape
            ...
            decoder_dense(res, self.batch_size, self.feature_size)
            assert 1 == 2
