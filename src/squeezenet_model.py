...
Source: https://github.com/tensorflow/tpu/tree/master/models/official/squeezenet
"""
...
def squeezenet(images, is_training=True, num_classes=1001):
  ...
  #_ net = tf.layers.max_pooling2d(net, [3, 3], strides=(2, 2), name="maxpool1")
  net = tf.layers.max_pooling2d(net, [2, 2], strides=(2, 2), name="maxpool1")
  net = fire_module(net, 16, 64, name="fire2")
  net = fire_module(net, 16, 64, name="fire3")
  net = fire_module(net, 32, 128, name="fire4")
  #_ net = tf.layers.max_pooling2d(net, [3, 3], strides=(2, 2), name="maxpool4")
  net = tf.layers.max_pooling2d(net, [2, 2], strides=(2, 2), name="maxpool4")
  ...
  #_net = tf.layers.max_pooling2d(net, [3, 3], strides=(2, 2), name="maxpool8")
  net = tf.layers.max_pooling2d(net, [2, 2], strides=(2, 2), name="maxpool8")
  net = fire_module(net, 64, 256, name="fire9")
  #_net = tf.layers.dropout(net, rate=0.5 if is_training else 0.0, name="drop9")
  net = conv2d(net, num_classes, [1, 1], strides=(1, 1), name="conv10")
  #_ net = tf.layers.average_pooling2d(net, pool_size=(13, 13), strides=(1, 1))
