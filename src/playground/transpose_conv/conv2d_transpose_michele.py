...
input = tf.constant(arr, tf.float32)
print(arr.shape)
print(arr)
print(input.shape)
...
conv = tf.nn.conv2d_transpose(input, w, output_shape=(1, 4, 4, 1), strides=[1, 2, 2, 1], padding='SAME')

with tf.Session() as sess:
    # TODO with your way of doing this part it does NOT work!
    out = sess.run(conv)
    print(out.shape)
    #print(out)
    print(out.reshape((4,4)))
